...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_DELETE,                                      KC_BSPC,        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       
    ...
    KC_LEFT_CTRL,   KC_LEFT,        KC_UP,          KC_DOWN,        KC_RIGHT,       KC_APPLICATION,                                                                                                 KC_ESCAPE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_LBRC,        KC_RBRC,        KC_RIGHT_CTRL,  
